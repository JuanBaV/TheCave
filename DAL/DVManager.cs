    ...
    public class DVManager
    {
        ...
        public DataTable ObtenerDatatableConcatenada(string nombreTable)
        {
            DataTable dataTable = new DataTable();
                ...
                {
                    Conection.Open();
                    using (SqlCommand command = new SqlCommand("InsertarDatosEnTablaRebote", Conection))
                    {
        ...
        //public void GuardarTable2(DataTable DtToSave, string tablaSobreescribir)
        //{
        ...
        //        using (SqlCommand command = new SqlCommand("CalcularVerificador", Conection))
        //        {
        //            command.CommandType = CommandType.StoredProcedure;
        //            command.Parameters.AddWithValue("@TableName", tablaSobreescribir);
        //            //command.Parameters.AddWithValue("@HashValue", row["HashValue"]);
        //            //command.Parameters.AddWithValue("@Id", row["Id"]);
